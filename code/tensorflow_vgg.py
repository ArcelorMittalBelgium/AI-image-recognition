...
#TODO adapt and implement https://gist.github.com/omoindrot/dedc857cdc0e680dfb1be99762990c9c
...
os.environ["CUDA_VISIBLE_DEVICES"]="3" #work only on one GPU
...
def main(args):
    ...
    train_filenames, val_filenames, train_labels, val_labels = train_test_split(X, y, test_size=0.33, random_state=0)
